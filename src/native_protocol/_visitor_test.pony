...
actor OldVisitorTestList is TestList
...
class iso _TestVisitFrame is UnitTest
    fun name(): String => "OldVisitor.visitFrame"
...
class iso _TestVisitStartupRequest is UnitTest
    fun name(): String => "OldVisitor.visitStartupRequest"
...
class iso _TestVisitAuthResponseRequest is UnitTest
    fun name(): String => "OldVisitor.visitAuthResponseRequest"

    fun tag apply(h: TestHelper) =>
        var request: AuthResponseRequest val = recover AuthResponseRequest() end
        var result: Array[U8 val] val = recover OldVisitor.visitAuthResponseRequest(request) end
        h.assert_eq[String val](
            "FFFFFFFF",
            Bytes.to_hex_string(result)
        )
        ...
        request = recover AuthResponseRequest(recover [as U8: 0xAB; 0xCD] end) end
        result = recover OldVisitor.visitAuthResponseRequest(request) end
        h.assert_eq[String val](
            "00000002ABCD",
            Bytes.to_hex_string(result)
        )
...
class iso _TestVisitOptionsRequest is UnitTest
    fun name(): String => "OldVisitor.visitOptionsRequest"

    fun tag apply(h: TestHelper) =>
        let request: OptionsRequest val = OptionsRequest
        let result: Array[U8 val] val = recover OldVisitor.visitOptionsRequest(request) end
        h.assert_eq[String val](
            "",
            Bytes.to_hex_string(result)
        )
...
class iso _TestVisitQueryRequest is UnitTest
    ...
    fun name(): String val =>
        "OldVisitor.visitQueryRequest"
    
    fun tag apply(h: TestHelper) ? =>
       var request: QueryRequest val = QueryRequest("SELECT * FROM example", None)
        var result: Array[U8 val] val = recover OldVisitor.visitQueryRequest(request) end
        h.assert_eq[String val](
        ...
        result = recover OldVisitor.visitQueryRequest(request) end
        h.assert_eq[String val](
...
class iso _TestVisitErrorResponse is UnitTest
    fun name(): String => "OldVisitor.visitErrorResponse"

    fun tag apply(h: TestHelper) =>
        let request: ErrorResponse val = ErrorResponse(0x0000, "Server error")
        let result: Array[U8 val] val = recover OldVisitor.visitErrorResponse(request) end
        h.assert_eq[String val](
...
class iso _TestVistReadyResponse is UnitTest
    fun name(): String => "OldVisitor.visitReady"
...
class iso _TestVisitAuthenticateResponse is UnitTest
    fun name(): String => "OldVisitor.visitAuthenticateResponse"

    fun tag apply(h: TestHelper) =>
        let response: AuthenticateResponse val = recover AuthenticateResponse("org.apache.cassandra.auth.PasswordAuthenticator") end
        let result: Array[U8 val] val = recover OldVisitor.visitAuthenticateResponse(response) end
        h.assert_eq[String val](
...
class iso _TestVisitAuthSuccessResponse is UnitTest
    fun name(): String => "OldVisitor.visitAuthSuccessResponse"

    fun tag apply(h: TestHelper) =>
        var response: AuthSuccessResponse val = recover AuthSuccessResponse() end
        var result: Array[U8 val] val = recover OldVisitor.visitAuthSuccessResponse(response) end
        h.assert_eq[String val](
            "FFFFFFFF",
            Bytes.to_hex_string(result)
        )
        ...
        result = recover OldVisitor.visitAuthSuccessResponse(response) end
        h.assert_eq[String val](
            "00000002ABCD",
            Bytes.to_hex_string(result)
        )
...
class iso _TestVisitQueryParameter is UnitTest
    ...
    fun name(): String =>
        "OldVisitor.visitQueryParameter"
    
    fun tag apply(h: TestHelper) ? =>
        var result: Array[U8 val] val = recover OldVisitor.visitQueryParameter("test") end
        h.assert_eq[String val]("0000000474657374", Bytes.to_hex_string(result))

        let bigint: I64 = 64
        result = recover OldVisitor.visitQueryParameter(bigint) end
        ...
        result = recover OldVisitor.visitQueryParameter(blob) end
        ...
        result = recover OldVisitor.visitQueryParameter(date) end
        ...
        result = recover OldVisitor.visitQueryParameter(double) end
        h.assert_eq[String val]("00000008400921FB5444261E", Bytes.to_hex_string(result))

        let float: F32 = F32.max_value()
        result = recover OldVisitor.visitQueryParameter(float) end
        ...
        result = recover OldVisitor.visitQueryParameter(net_address) end
        ...
        result = recover OldVisitor.visitQueryParameter(tinyint) end
        h.assert_eq[String val]("000000020010", Bytes.to_hex_string(result))

class iso _TestVisitConsistency is UnitTest

    fun name(): String =>
        "OldVisitor.visitConsistency"
    
    fun tag apply(h: TestHelper) =>
        h.assert_eq[String val]("0000", Bytes.to_hex_string(OldVisitor.visitConsistency(AnyConsistency)))
        h.assert_eq[String val]("0001", Bytes.to_hex_string(OldVisitor.visitConsistency(One)))
        h.assert_eq[String val]("0002", Bytes.to_hex_string(OldVisitor.visitConsistency(Two)))
        h.assert_eq[String val]("0003", Bytes.to_hex_string(OldVisitor.visitConsistency(Three)))
        h.assert_eq[String val]("0004", Bytes.to_hex_string(OldVisitor.visitConsistency(Quorum)))
        h.assert_eq[String val]("0005", Bytes.to_hex_string(OldVisitor.visitConsistency(All)))
        h.assert_eq[String val]("0006", Bytes.to_hex_string(OldVisitor.visitConsistency(LocalQuorum)))
        h.assert_eq[String val]("0007", Bytes.to_hex_string(OldVisitor.visitConsistency(EachQuorum)))
        h.assert_eq[String val]("0008", Bytes.to_hex_string(OldVisitor.visitConsistency(Serial)))
        h.assert_eq[String val]("0009", Bytes.to_hex_string(OldVisitor.visitConsistency(LocalSerial)))
        h.assert_eq[String val]("000A", Bytes.to_hex_string(OldVisitor.visitConsistency(LocalOne)))
        

class iso _TestVisitNone is UnitTest
    fun name(): String => "OldVisitor.visitNone"

    fun tag apply(h: TestHelper) =>
        let collector = Array[U8 val]()
        OldVisitor.visitNone(None, collector)
        h.assert_eq[USize](0, collector.size())

class iso _TestVisitInt is UnitTest
    fun name(): String => "OldVisitor.visitInt"

    fun tag apply(h: TestHelper) ? =>
        var collector = Array[U8 val]()
        OldVisitor.visitInt(I32.min_value(), collector)
        ...
        OldVisitor.visitInt(I32.max_value(), collector)
...
class iso _TestVisitShort is UnitTest
    fun name(): String => "OldVisitor.visitShort"

    fun tag apply(h: TestHelper) ? =>
        var collector = Array[U8 val]()
        OldVisitor.visitShort(U16.min_value(), collector)
        h.assert_eq[U8](0x00, collector(0))
        h.assert_eq[U8](0x00, collector(1))
        
        collector = Array[U8 val]()
        OldVisitor.visitShort(U16.max_value(), collector)
        h.assert_eq[U8](0xFF, collector(0))
        h.assert_eq[U8](0xFF, collector(1))

class iso _TestVisitBytes is UnitTest
    fun name(): String => "OldVisitor.visitBytes"

    fun tag apply(h: TestHelper) ? =>
        var collector = Array[U8 val]()
        OldVisitor.visitBytes(recover [as U8: 0xAB; 0xCD] end, collector)
        h.assert_eq[U8](0x00, collector(0))
        h.assert_eq[U8](0x00, collector(1))
        h.assert_eq[U8](0x00, collector(2))
        ...
        collector = Array[U8 val]()
        OldVisitor.visitBytes(None, collector)
        h.assert_eq[U8](0xFF, collector(0))
        h.assert_eq[U8](0xFF, collector(1))
        h.assert_eq[U8](0xFF, collector(2))
        h.assert_eq[U8](0xFF, collector(3))
...
class iso _TestVisitString is UnitTest
    fun name(): String => "OldVisitor.visitString"

    fun tag apply(h: TestHelper) ? =>
        var collector = Array[U8 val]()
        OldVisitor.visitString("CQL_VERSION", collector)
        h.assert_eq[U8](0x00, collector(0))
...
class iso _TestVisitStringList is UnitTest
    fun name(): String => "OldVisitor.visitStringList"

    fun tag apply(h: TestHelper) ? =>
        var collector = Array[U8 val]()
        var data: Array[String val] val = recover ["1"; "2"] end
        OldVisitor.visitStringList(data, collector)
        h.assert_eq[U8](0x00, collector(0))
...
class iso _TestVisitStringMap is UnitTest
    fun name(): String => "OldVisitor.visitStringMap"
    ...
    fun tag apply(h: TestHelper) ? =>
        ...
        let collector: Array[U8 val] val = recover
            let c = Array[U8 val]()
            OldVisitor.visitStringMap(data, c)
            c
        end
